...
-- Use kind="grid", columns=3, cell_width=100, cell_height=60 for fixed-column controls.
-- UI children can add artwork:
-- { id="art", kind="image", width=64, height=64,
--   sprite=sf2.assets.sprite("YOUR_MOD_ID:sprites/reward") }
-- Put reward.png in assets/sprites.
...
-- sf2.ui.set_sprite(view, "portrait", icon) updates an existing image
